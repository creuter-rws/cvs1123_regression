...
ACLOCAL = ${SHELL} /space/testing/run/cvs1123/missing --run aclocal-1.10
AMTAR = ${SHELL} /space/testing/run/cvs1123/missing --run tar
AUTOCONF = ${SHELL} /space/testing/run/cvs1123/missing --run autoconf
AUTOHEADER = ${SHELL} /space/testing/run/cvs1123/missing --run autoheader
AUTOMAKE = ${SHELL} /space/testing/run/cvs1123/missing --run automake-1.10
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /space/testing/run/cvs1123/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MKTEMP = /bin/mktemp
OBJEXT = o
PACKAGE = cvs
...
PERL = /usr/bin/perl
PR = /usr/bin/pr
PS2PDF = /space/testing/run/cvs1123/missing ps2pdf
RANLIB = ranlib
ROFF = /usr/bin/groff
...
SHELL = /bin/bash
STRIP = 
TEXI2DVI = /space/testing/run/cvs1123/missing texi2dvi
VERSION = 1.11.23
YACC = yacc
YFLAGS = 
abs_builddir = /space/testing/run/cvs1123
abs_srcdir = /space/testing/run/cvs1123
abs_top_builddir = /space/testing/run/cvs1123
abs_top_srcdir = /space/testing/run/cvs1123
ac_ct_CC = gcc
ac_prefix_program = 
am__include = include
am__leading_dot = .
...
install_sh = $(SHELL) /space/testing/run/cvs1123/install-sh
